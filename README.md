...
ellipsoids
================
Marlon E. Cobos, Luis Osorio-Olvera, Jorge Soberón, Vijay Barve, Narayani Barve,
...
space. The function *ellipsoid\_overlap* helps is performing needed
analyses. To plot results use the function *plot\_overlap*.
