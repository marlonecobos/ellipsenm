...
```{r Figure4, fig.cap="Representation of suitability values in environmental space for the calibration area. Occurrence data is represented in blue. Cold colors represent low suitabilities and warm colors high suitabilities."}
...
```{r Figure5, fig.cap="Representation of suitability values in environmental space for a scenario of projection. Occurrence data is represented in blue. Cold colors represent low suitabilities and warm colors high suitabilities."}
...
```{r Figure6, fig.cap="Representation of suitability values in geographic space. Occurrence data is represented in blue. Cold colors represent low suitabilities and warm colors high suitabilities. Grey lines represent country borders."}
par(mar = c(2, 2, 1, 1))
...
```{r Figure7, fig.cap="Representation of suitability values in geography for a projection scenario. Occurrence data is represented in blue. Cold colors represent low suitabilities and warm colors high suitabilities. Grey lines represent country borders."}
par(mar = c(2, 2, 1, 1))
