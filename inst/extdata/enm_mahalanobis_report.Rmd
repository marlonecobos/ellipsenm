...
```{r Figure4, fig.cap="Representation of Mahalanobis distances in geographic space. Occurrence data is represented in blue. Cold colors represent long distances and warm colors short distances. Grey lines represent country borders."}
par(mar = c(2, 2, 1, 1))
