...
```{r Figure1, fig.cap="Representation of species occurrence data in geographic space. Grey lines represent country borders."}
par(mar = c(2, 2, 1, 1))
...
```{r Figure4, fig.cap="Representation of suitability values in geographic space. Occurrence data is represented in blue. Cold colors represent low suitabilities and warm colors high suitabilities. Grey lines represent country borders."}
par(mar = c(2, 2, 1, 1))
