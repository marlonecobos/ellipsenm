...
author: "Marlon E. Cobos, Luis Osorio-Olvera, Jorge Soberón, A. Townsend Peterson, Vijay Barve, and Narayani Barve"
output:
  github_document:
    toc: yes
    toc_depth: 3
...
packages <- c("ellipsenm", "knitr", "raster", "rgl")
suppressWarnings(s <- sapply(packages, function(x) {library(x, character.only = T)}))
opts_chunk$set(echo = TRUE, collapse = TRUE, comment = "#>", webgl = hook_webgl)
```
