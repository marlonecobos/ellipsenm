...
#' \code{\link{thin_data}}, \code{\link{split_ata}}, \code{\link{data_subsample}},
#' \code{\link{buffer_area}}, \code{\link{convex_area}}, \code{\link{concave_area}},
#' \code{\link{polygon_selection}}, \code{\link{explore_espace}},
#' \code{\link{ellipsoid_fit}}, \code{\link{ellipsoid_calibration}},
#' \code{\link{predict}}, \code{\link{ellipsoid_model}},
#' \code{\link{model_projection}}, \code{\link{partial_roc}},
#' \code{\link{omission_rate}}
#'
#' @docType package
#' @name ellipsenm
NULL
